...
export default defineSchema({
  ...
  auditLogs: defineTable({
    ...
    metadata: v.optional(v.record(v.string(), _simpleJsonValue)),
  ...
  // =============================================================================
  // Forum Enhancement Tables (2025 Modern Features)
  // =============================================================================
  ...
  soft_deletes: defineTable({
    ...
    .index('by_deleted_by', ['deletedBy', 'createdAt']),
});
