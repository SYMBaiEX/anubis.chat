...
import { z } from 'zod';
// Fallback lightweight logger for forum
const createModuleLogger = (module: string) => ({
  info: (...args: unknown[]) => (console && console.info ? console.info(`[${module}]`, ...args) : undefined),
  warn: (...args: unknown[]) => (console && console.warn ? console.warn(`[${module}]`, ...args) : undefined),
  error: (...args: unknown[]) => (console && console.error ? console.error(`[${module}]`, ...args) : undefined),
});
