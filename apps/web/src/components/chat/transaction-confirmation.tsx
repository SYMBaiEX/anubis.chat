...
import { useSolanaAgent, type BlockchainTransaction } from '@/components/providers/solana-agent-provider';
import {
  AlertTriangle,
  CheckCircle,
  ExternalLink,
                ...
                <div>
                  ...
                  {signature && (
                    <div className="mt-2 flex items-center space-x-2">
                      <code className="rounded bg-green-100 px-2 py-1 text-xs text-green-800 dark:bg-green-800 dark:text-green-200">
                        {signature}
                      </code>
                      <Button
                ...
                <div className="space-y-3">
                  {transaction.parameters.amount && (
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium">{transaction.parameters.amount}</span>
                    </div>
                  )}
                  ...
                  {transaction.parameters.tokenMint && (
                    <div className="flex justify-between items-center">
                      ...
                      <code className="text-xs">{transaction.parameters.tokenMint.slice(0, 8)}...</code>
                    </div>
                  )}
                  ...
                  {transaction.parameters.targetAddress && (
                    <div className="flex justify-between items-center">
                      ...
                      <code className="text-xs">{transaction.parameters.targetAddress.slice(0, 8)}...</code>
                    </div>
                  )}

                  {transaction.parameters.slippage && (
                    <div className="flex justify-between items-center">
                      <span className="text-muted-foreground text-sm">Slippage:</span>
              ...
              {getRiskLevel() !== 'low' && (
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3 dark:border-yellow-800 dark:bg-yellow-900/20">
                  <div className="flex items-start space-x-2">
                    ...
                    <div>
                      <h4 className="font-medium text-yellow-800 text-sm dark:text-yellow-200">
                        {getRiskLevel() === 'high' ? 'High Risk Transaction' : 'Medium Risk Transaction'}
                      </h4>
