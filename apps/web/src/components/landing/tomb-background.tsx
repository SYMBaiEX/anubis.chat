...
export function TombBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 transition-all duration-700">
      ...
      <div className={`absolute inset-0 transition-opacity duration-700 ${isDark ? 'opacity-30' : 'opacity-20'}`}>
        <div
      ...
      <div className={`absolute inset-0 transition-opacity duration-700 ${isDark ? 'opacity-20' : 'opacity-15'}`}>
        <svg className="w-full h-full transition-all duration-700" viewBox="0 0 100 100" preserveAspectRatio="none">
          <path
      ...
      {/* Gold accent glow for mystical effect */}
      <div className={`absolute inset-0 pointer-events-none transition-opacity duration-700 ${isDark ? 'opacity-5' : 'opacity-3'}`}>
        <div
          className="absolute top-1/4 left-1/3 w-32 h-32 blur-3xl transition-all duration-1000"
          style={{
        ...
        />
        <div
          className="absolute bottom-1/3 right-1/4 w-40 h-40 blur-3xl transition-all duration-1000"
          style={{
