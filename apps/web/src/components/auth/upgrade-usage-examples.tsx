...
import { Shield, Zap, FileUp, Code, Crown } from 'lucide-react';
import { useUpgrade } from './upgrade-wrapper';
import { FeatureGate } from './upgrade-wrapper';
...
export function UpgradeUsageExamples() {
  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        <h2 className="text-xl font-semibold mb-2">Upgrade System Examples</h2>
      ...
      <Card className="p-6">
        <h3 className="font-medium mb-4">Manual Upgrade Triggers</h3>
        <div className="flex flex-wrap gap-3">
          ...
          <Button
            onClick={() => openUpgradeModal({ tier: 'pro_plus', trigger: 'manual' })}
            variant="outline"
          >
          ...
          <Button
            onClick={() => openUpgradeModal({ tier: 'pro', trigger: 'feature_request' })}
            variant="outline"
          >
      ...
      <Card className="p-6">
        <h3 className="font-medium mb-4">Feature Gates</h3>
        
        {/* API Access - Requires Pro+ */}
        <div className="mb-4">
          <h4 className="text-sm font-medium text-muted-foreground mb-2">API Access (Pro+ Required)</h4>
          <FeatureGate feature="api_access">
            <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                You can now use our REST API to integrate ISIS Chat into your applications.
              </p>
            </div>
          </FeatureGate>
        </div>
        ...
        <div className="mb-4">
          <h4 className="text-sm font-medium text-muted-foreground mb-2">Large File Upload (Pro+ Required)</h4>
        ...
        <div className="mb-4">
          <h4 className="text-sm font-medium text-muted-foreground mb-2">Premium Models (Pro Required)</h4>
          <FeatureGate feature="premium_models">
            <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
              <div className="flex items-center space-x-2">
                <Zap className="h-5 w-5 text-purple-600 dark:text-purple-400" />
                <span className="font-medium">GPT-4o & Claude 3.5 Available</span>
                <Badge variant="secondary">Pro</Badge>
              </div>
              <p className="mt-2 text-sm text-muted-foreground">
      ...
      <Card className="p-6">
        <h3 className="font-medium mb-4">Programmatic Feature Checks</h3>
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded">
            <span className="text-sm">API Access:</span>
            <Badge variant={checkFeature('api_access') ? 'default' : 'secondary'}>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded">
            ...
            <Badge variant={checkFeature('premium_models') ? 'default' : 'secondary'}>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded">
            ...
            <Badge variant={checkFeature('large_files') ? 'default' : 'secondary'}>
      ...
      <Card className="p-6">
        <h3 className="font-medium mb-4">Require Feature Pattern</h3>
        <p className="text-sm text-muted-foreground mb-4">
          This demonstrates how to programmatically check and prompt for upgrades.
        </p>
