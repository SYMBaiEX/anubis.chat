...
export function RosettaHieroglyphs() {
  ...
  return (
    <div 
      className={`fixed inset-0 pointer-events-none overflow-hidden transition-opacity duration-[3000ms] ${
    ...
    >
      ...
      <div 
        className="absolute hieroglyphic_version"
        style={{
          top: '10%',
          left: '5%',
      ...
      >
        <div className="x-3">
          ...
          <span className="vert">
            𓎟
            <span className="vertkerning">𓐍𓂤</span>
            𓐝
          </span>
