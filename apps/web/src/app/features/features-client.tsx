...
const featureCategories = {
    ...
    features: [
      {
        ...
        description: 'Access cutting-edge AI models including GPT-5, GPT-5 Mini, Gemini 2.5 Pro, and o4-mini for premium intelligence.',
        icon: Brain,
        details: [
      ...
      },
      {
        ...
        description: 'Start with powerful free models including GPT-OSS-20B, GLM-4.5-Air, Qwen3-Coder, and Kimi K2.',
        icon: Sparkles,
        details: [
      ...
      },
      {
        ...
        description: 'Advanced context retention and conversation memory for more coherent and relevant responses.',
        icon: Database,
        details: [
    ...
    features: [
      {
        ...
        description: 'Secure, passwordless authentication using your Solana wallet signature.',
        icon: Wallet,
        details: [
      ...
      },
      {
        ...
        description: 'Pay for subscriptions directly with SOL or SPL tokens through secure blockchain transactions.',
        icon: Lock,
        details: [
      ...
      },
      {
        ...
        description: 'Your data is encrypted and stored with blockchain-level security.',
        icon: Shield,
        details: [
    ...
    features: [
      {
        ...
        description: 'Experience instant AI responses with ultra-low latency streaming technology.',
        icon: Zap,
        details: [
      ...
      },
      {
        ...
        description: 'All your chats are automatically saved and synced across all your devices.',
        icon: Clock,
        details: [
      ...
      },
      {
        ...
        description: 'Unique ancient Egyptian aesthetics combined with modern design principles.',
        icon: Palette,
        details: [
  ...
  developer: {
    ...
    features: [
      {
        title: 'API Access',
        description: 'Coming soon: RESTful API for integrating ANUBIS AI into your applications.',
        icon: Code,
        details: [
      ...
      {
        title: 'Custom Agents',
        description: 'Build and deploy custom AI agents with specialized knowledge and behaviors.',
        icon: Network,
        details: [
      ...
      },
      {
        ...
        description: 'Create complex multi-step workflows with conditional logic and integrations.',
        icon: Layers,
        details: [
...
function InteractiveFeatureCard({ feature, index }: { feature: any; index: number }) {
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Explore the comprehensive suite of features that make ANUBIS the most advanced
              Web3-native AI platform available today.
            </motion.p>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="mx-auto max-w-2xl text-muted-foreground">
                        Discover the advanced capabilities that set ANUBIS apart.
                      </p>
                    </motion.div>
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Join thousands of users already leveraging the power of Web3-native AI.
            </motion.p>
            <motion.div
