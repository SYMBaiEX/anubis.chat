...
export const metadata: Metadata = {
  ...
  description: 'Choose from Free, Pro, or Pro+ plans for ANUBIS AI Chat. Pay with SOL for premium AI models including GPT-5, Gemini 2.5 Pro, and more. Transparent pricing, no hidden fees.',
  keywords: [
    'AI chat pricing',
    'Solana payment',
  ...
  openGraph: {
    ...
    description: 'Affordable AI chat plans starting free. Pay with SOL for premium models like GPT-5, Gemini 2.5 Pro. Choose Free, Pro (0.05 SOL/mo), or Pro+ (0.1 SOL/mo).',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'Transparent pricing for Web3-native AI chat. Free plan available, Pro starts at 0.05 SOL/month.',
    images: ['/api/og?title=ANUBIS%20Pricing&description=Pay%20with%20SOL&theme=pricing'],
  },
  alternates: {
    canonical: '/pricing',
  },
