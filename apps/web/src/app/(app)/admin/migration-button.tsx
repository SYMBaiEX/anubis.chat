...
export function MigrationButton() {
  ...
  const cleanupUsers = useMutation(api.migrations.removeUpdatedAt.cleanupUsersTable);
  const fixBlacklistedTokens = useMutation(api.migrations.fixBlacklistedTokens.fixBlacklistedTokens);
