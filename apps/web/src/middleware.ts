...
export function middleware(request: NextRequest) {
  ...
  const cspHeader = `
    ...
    media-src 'self' blob:;
    connect-src 'self' wss://*.convex.cloud https://*.convex.cloud https://api.openai.com https://api.anthropic.com https://api.google.com https://openrouter.ai https://*.vercel-analytics.com https://api.devnet.solana.com https://api.mainnet-beta.solana.com https://api.testnet.solana.com wss://api.devnet.solana.com wss://api.mainnet-beta.solana.com wss://api.testnet.solana.com https://*.helius-rpc.com wss://*.helius-rpc.com https://*.quicknode.pro wss://*.quicknode.pro ws://localhost:* http://localhost:*;
    frame-src 'self';
    object-src 'none';
    base-uri 'self';
    form-action 'self';
